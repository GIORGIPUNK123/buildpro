...
export const FirstSection = () => {
  return (
    <section className='py-24 pt-36 md:pt-44 md:py-32 lg:py-64 bg-gradient-to-r from-accent/10 to-background'>
      <div className='container flex flex-col items-center justify-between gap-12 px-6 mx-auto lg:flex-row'>
        <div className='flex-1 space-y-8 text-center lg:text-left'>
          <h1 className='text-4xl font-bold leading-tight lg:text-5xl'>
            Build Stunning, Interactive Websites With the BuildPro Team
            {/* <br className='hidden lg:block' /> */}
          </h1>

          <p className='text-lg lg:max-w-lg text-muted'>
